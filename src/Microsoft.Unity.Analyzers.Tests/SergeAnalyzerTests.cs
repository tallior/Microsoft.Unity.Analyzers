...
{
	public class SergeAnalyzerTests : BaseCodeFixVerifierTest<SergeAnalyzer, SetPositionAndRotationCodeFix>
	{
		[Fact]
		public async Task ShowMeThePropertyNameMotherFucker()
		{
			const string test = @"
using UnityEngine;
